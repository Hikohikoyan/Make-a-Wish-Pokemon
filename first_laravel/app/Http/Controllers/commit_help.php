    ...
    public function index( Request $request){
        ...
        if($help_times==2){
            ...
            if($change_situation==0){
                return response()->json(['errcode'=>2,'errmsg'=>"请试试别的愿望"])->setEncodingOptions(JSON_UNESCAPED_UNICODE);
            }else{
                return response()->json(['errcode'=>0,'errmsg'=>"领取愿望成功，恭喜你获得了一只精灵球，快去打开看看吧"])->setEncodingOptions(JSON_UNESCAPED_UNICODE);
            }
        }
    }
 }