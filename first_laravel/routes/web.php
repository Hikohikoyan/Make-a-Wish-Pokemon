...
Route::get('/get_pre_wishes/','get_pre_wishes@index')->middleware('Start_finish_game','get_openid');//查看预定义愿望
Route::get('/Check_login/','Check_login@index')->middleware('Start_finish_game');
Route::group(['middleware'=>['Start_finish_game','get_openid','user_exist']],function(){
...
Route::group(['middleware'=>['Start_finish_game','get_openid']],function(){
...
Route::group(['middleware'=>['Start_finish_game','get_openid','caculate_ball']],function(){
